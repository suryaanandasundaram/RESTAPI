...
public class PutChangeRequestAssertion {
	...
	void putChangeRequest()
	{
		...
		res.then().log().all().assertThat().body("result.short_description",Matchers.containsString("using put method for hamcrest")).
		body("result.number",Matchers.equalTo("CHG0030005")).statusCode(200);
